...
func init() {
	webFiles["colResizable.js"] = colresizableJS
}

const colresizableJS = `// colResizable 1.6 - a jQuery plugin by Alvaro Prieto Lauroba http://www.bacubacu.com/colresizable/
